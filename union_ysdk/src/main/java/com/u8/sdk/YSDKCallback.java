        ...
        if (PayRet.RET_SUCC == ret.ret) {
            ...
            switch (ret.flag) {
                ...
                case eFlag.Pay_Param_Error:
                    YSDK.showTip("支付参数错误," + ret.toString());
                ...
                default:
                    YSDK.showTip("支付异常，" + ret.toString());
