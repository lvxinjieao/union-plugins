...
//		Log.i("U8SDK", "GET请求URL：" + urlStr);
//		Log.i("U8SDK", "GET请求参数：" + params.toString());
...
//			Log.i("union", "请求fullUrl：" + fullUrl);
			...
			if (url.getProtocol().toUpperCase().equals("HTTPS")) {
				...
				https.setHostnameVerifier(U8HttpUtils.DO_NOT_VERIFY);
				connection = https;
			} else {
	...
	public static String httpPost(String urlStr, Map<String, String> params) {
		...
		Log.i("U8SDK", "POST请求URL：" + urlStr);
		Log.i("U8SDK", "POST请求参数：" + params.toString());
	 ...
	 * application/x-www-form-urlencoded list of parameters in an HTTP PUT or HTTP
	 * POST.
	 *
	 * @param params
	 * @param charset
	 ...
	 */
	public static String urlParamsFormat(Map<String, String> params, String charset)
			throws UnsupportedEncodingException {
